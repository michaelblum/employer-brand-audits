...
DEI_COMPETITOR_AUDIT_DEFAULT_PROFILE_PATH = COMPETITOR_WORKBOOK_DEFAULT_PROFILE_PATH
...
CAMPAIGN_DESK_RESEARCH_DEFAULT_PROFILE_PATH = REPO_ROOT / "data" / "publication-pipeline-profiles" / "scottish-power-campaign-desk-research-2025.json"
...
def build_dei_competitor_audit_manifest(profile: dict[str, Any]) -> dict[str, Any]:
    ...
    return {
        ...
        "artifacts": [
            ...
            manifest_artifact("p4-dei-activation-matrix", 4, "html", "p4-dei-activation-matrix-view", ["p3-dei-analysis-pack", "p2-dei-evidence-matrix"], "dei-activation-matrix.html", "publication.dei_activation_matrix", "DEI activation matrix view"),
            manifest_artifact("p4-inclusion-philosophy-map", 4, "html", "p4-inclusion-philosophy-map-view", ["p3-dei-analysis-pack", "p2-dei-evidence-matrix"], "inclusion-philosophy-map.html", "publication.inclusion_philosophy_map", "Inclusion philosophy map view"),
            manifest_artifact("p4-partner-landscape", 4, "html", "p4-partner-landscape-view", ["p3-dei-analysis-pack", "p2-dei-evidence-matrix"], "partner-landscape.html", "publication.partner_landscape", "Partner landscape view"),
            manifest_artifact("p4-competitor-audit-deck", 4, "audit_deck", "p4-competitor-audit-deck-view", ["p3-dei-analysis-pack", "p2-dei-evidence-matrix", "p1-deck-extraction"], "competitor-audit-deck-view.html", "publication.audit_deck", "DEI competitor audit deck view"),
            manifest_artifact("p4-l4-publication", 4, "l4_publication", "p4-l4-publication-view", ["p3-dei-analysis-pack", "p2-dei-evidence-matrix", "p1-deck-extraction"], "l4-publication.html", "publication.l4_publication", "DEI audit L4 readout"),
        ],
    }


def generate_dei_competitor_audit_fixture(
    output_dir: Path = REPO_ROOT / "artifacts" / "dei-competitor-audit" / "latest",
    *,
    project_profile_path: Path | None = None,
) -> Path:
    output_dir = output_dir.resolve()
...
def build_campaign_manifest(profile: dict[str, Any]) -> dict[str, Any]:
    ...
    return {
        ...
        "artifacts": [
            ...
            manifest_artifact("p4-campaign-recommendation-readout", 4, "html", "p4-campaign-recommendation-readout", ["p3-campaign-lessons-analysis-pack"], "campaign-recommendation-readout.html", "publication.campaign_recommendation_readout", "Campaign recommendation readout"),
            manifest_artifact("p4-l4-publication", 4, "l4_publication", "p4-l4-publication-view", ["p3-campaign-lessons-analysis-pack", "p2-channel-tactic-opportunity-map", "p2-campaign-case-matrix"], "l4-publication.html", "publication.l4_publication", "Campaign L4 publication readout"),
        ],
    }


def generate_campaign_desk_research_fixture(
    output_dir: Path = REPO_ROOT / "artifacts" / "campaign-desk-research-comp-audit" / "latest",
    *,
    project_profile_path: Path | None = None,
) -> Path:
    output_dir = output_dir.resolve()
...
def build_kilos_methodology_manifest() -> dict[str, Any]:
    return {
        ...
        "artifacts": [
            ...
            manifest_artifact("p3-report-section-snippets", 3, "html", "p3-report-section-snippets", ["p2-scorecard-tables", "p1-mapping-workbook"], "report-section-snippets.html", "publication.report_section_snippets", "Reusable KILOS report snippets"),
            manifest_artifact("p4-l4-publication", 4, "l4_publication", "p4-l4-publication-view", ["p3-report-section-snippets", "p2-scorecard-tables", "p1-kilos-browser"], "l4-publication.html", "publication.l4_publication", "KILOS methodology publication"),
        ],
    }


def generate_kilos_methodology_fixture(
    output_dir: Path = REPO_ROOT / "artifacts" / "kilos-methodology" / "latest",
) -> Path:
    output_dir = output_dir.resolve()
    if output_dir.exists():
        shutil.rmtree(output_dir)
