...
ARTIFACT_FIXTURE_SUMMARY_TEMPLATE = """# {title} Artifact Summary

## Captured Source

- URL: {url}
- Target selector: `{target_used}`
- Viewport: {width} x {height}

## Live Artifact Purpose

This markdown file is an explicit artifact fixture emitted by the public-page
matrix smoke run so the artifact workbench has an editable text artifact
...
flowchart TD
  ...
  project --> workbench[Artifact workbench]
```
"""
...
def run_page(
    *,
    ...
    try:
        ...
        write_artifact_summary_markdown(manifest, page, summary_path)
